...
export const produkte: Produkt[] = [
  ...
  // Zuordnung: docs/website-migration/zuordnung-sichtestrich-microtop.md
  {
    ...
    normen: ["DIN EN 13813", "DIN 18560-2", "DIN 18560-3", "DIN 18560-4"],
    technischeDaten: [
  ...
  },
  {
    ...
    normen: ["DIN EN 13813", "DIN 18560-3"],
    technischeDaten: [
  ...
  },
  {
    ...
    normen: ["DIN EN 13813", "DIN 1100", "DIN 18560-2", "DIN 18560-3", "DIN 18560-4"],
    technischeDaten: [
      { label: "Schleifverschleiß", wert: "≤ 5 cm³/50 cm²" },
  ...
  },
  {
    ...
    normen: ["DVGW W 270", "DVGW W 300", "DVGW W 347", "DIN 18551"],
    technischeDaten: [
  ...
  },
  {
    ...
    bereich: "microtop",
    produktgruppe: "nassspritz",
    kurzbeschreibung: "Spritzmörtel für die Innenauskleidung und Instandsetzung von Trinkwasserbehältern und Mauerwerk",
  ...
  // zuordnung-spezialbaustoffe-rapidset.md).
  {
    ...
    qualitaetsklasse: "C55/67",
    normen: ["DIN EN 13395-2", "DIN EN 445"],
  ...
  },
  {
    ...
    bereich: "spezialbaustoffe",
    produktgruppe: "verguss",
    kurzbeschreibung: "Vergussbeton nach DIN EN 1504-3 (R4) und DAfStb-Richtlinie (SKVB II)",
    normen: ["DIN EN 1504-3 (R4)", "DAfStb-Richtlinie", "DIN EN 206-1", "DIN 1045-2"],
    technischeDaten: [],
    besonderheiten: ["DAfStb-Richtlinie (SKVB II)", "DVGW-Eignung lt. Normenübersicht"],
    zeitKategorie: "normal",
  },
  {
    id: "neodur-svm-03",
