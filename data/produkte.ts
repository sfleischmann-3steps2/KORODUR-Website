...
export const produkte: Produkt[] = [
  ...
  },
  {
    ...
    technischeDaten: [
      { label: "Haftzugfestigkeit", wert: "≥ 1,0 N/mm²", norm: "DIN 18365, DIN 18560" },
  ...
  },
  {
    ...
    verarbeitung: {"untergrundvorbereitung": "Untergrund säubern; lose Bestandteile, Zementschlämme, Staub, Säuren, Öl und Fett entfernen. Oberfläche muss kraftschlüssig, rissefrei, eben sowie rau und offenporig sein; Oberflächenzugfestigkeit mindestens 1 N/mm². Vor der Verarbeitung gründlich vornässen (bei stark saugenden Untergründen ggf. mehrfach wiederholen), dabei Wasserfilm bzw. Pfützenbildung vermeiden.", "mischverhaeltnis": "Wasserzugabe ca. 3,0 - 4,5 l je 25-kg-Gebinde. Mit geeignetem Zwangsmischer oder Rührquirl ca. 1 - 3 Minuten mischen: zunächst Wasser vorlegen, dann bei laufendem Mischer MORTAR MIX zugeben. Maximale Wasserzugabe nicht überschreiten. Materialverbrauch ca. 2,0 kg je m² und mm.", "schichtaufbau": "Einbaudicke 10 - 150 mm (MORTAR MIX DUR als Bodensanierung > 15 mm). Einbau in einer kompletten Lage, nicht schichtweise, möglichst gleichmäßig. Richtwerte: Boden 10 - 150 mm, Decke/über Kopf i. M. 15 mm, Wand i. M. 20 mm. Horizontal, vertikal und über Kopf verarbeitbar; anschließend glätten, reiben oder strukturieren.", "verarbeitungszeit": "Verarbeitungs-, Umgebungs- und Untergrundtemperatur mindestens 5 °C. Erstarrungsbeginn ca. 15 Minuten, Erstarrungsende ca. 35 Minuten. Bei über 20 °C verkürzt sich die Verarbeitungszeit, unter 20 °C verlängert sie sich. Verlängerung über Rapid Set SET CONTROL (Verzögerer) möglich.", "aushaertezeit": "Belastbar nach ca. 60 Minuten (ca. 1 Stunde nach Erstarrungsende). Belegreife: diffusionsoffene Beläge nach ca. 2 Std., diffusionsdichte Beläge nach ca. 16 Std. (Restfeuchte durch Messung prüfen).", "besonderheiten": "MORTAR MIX DUR enthält für hohen Schleifverschleiß einen Verschleißträger gem. DIN 1100 Gruppe A (KORODUR VS 0/5), auf Anfrage lieferbar. Nachbehandlung ausschließlich mit Wasser, unmittelbar nach Verlust des feuchten Glanzes und innerhalb einer Stunde wiederholen, bis ausreichende Festigkeit erreicht ist. Keine Verlegung auf gefrorenem Untergrund; Lufteinschlüsse beim Einbau vermeiden. Additive: Rapid Set FLOW CONTROL (Plastifizierer) und FAST (Beschleuniger)."},
    kategorie: "schnellzement",
    ...
    technischeDaten: [
      ...
      { label: "Druckfestigkeit (1 h)", wert: "≥ 21 N/mm²", norm: "DIN EN 1015-11" },
      { label: "Druckfestigkeit (24 h)", wert: "≥ 42 N/mm²", norm: "DIN EN 1015-11" },
      { label: "Verarbeitbar", wert: "pastös bis plastisch" },
      { label: "Voll belastbar nach", wert: "ca. 1 h" },
    ],
    besonderheiten: [
  ...
  },
  {
    ...
    verarbeitungModi: [{"titel": "Schicht auf erhärteten Beton (50 - 600 mm)", "schritte": ["Untergrund: Untergrund säubern, lose Bestandteile, Zementschlämme, Staub, Säuren, Öl und Fett entfernen. Oberfläche muss rau und offenporig sein, kraftschlüssiger Verbund rissfrei. Oberflächenzugfestigkeit min. 1,0 N/mm² (Regelwerke beachten). Vor der Verarbeitung gründlich vornässen, bei stark saugenden Untergründen ggf. mehrmals; Wasserfilm bzw. Pfützenbildung vermeiden. Bei Bedarf Grundierung auf Acrylatbasis.", "Mischen: Wasserzugabe ca. 3,0 - 3,75 l je 25 kg-Gebinde. Zuerst Wasser in den Mischbehälter, dann bei laufendem Mischer Produkt zugeben. Ca. 1 - 3 Minuten im Zwangsmischer oder mit Rührquirl mischen. Maximale Wasserzugabe nicht überschreiten (geringere Zugabe erhöht die Festigkeiten). Materialverbrauch ca. 2,0 kg je m² je mm.", "Auftrag: Einbaudicke 50 - 600 mm, direkt ohne Haftbrücke. Einbau in einer kompletten Lage (nicht schichtweise), möglichst gleichmäßig. Kann geglättet, gerieben oder mit Struktur versehen werden. Bei der Verdichtung Luftporen weitgehend vermeiden.", "Verarbeitungszeit: Endbearbeitung so schnell wie möglich. Verarbeitungs-, Umgebungs- und Untergrundtemperatur ≥ 5 °C. Bei > 20 °C verkürzt sich die Verarbeitungszeit, bei < 20 °C kann sich die Festigkeitsentwicklung verzögern. Zur Verlängerung Rapid Set SET CONTROL (Verzögerer) zugebbar. Keine Verlegung auf gefrorenen Untergründen. Erstarrungsbeginn ca. 15 Minuten, Erstarrungsende ca. 35 Minuten (Anlehnung an DIN EN 196-3).", "Aushärtung: Belastbar ca. 60 Minuten nach Erstarrungsende (befahrbar und belastbar bereits nach ca. 1 Stunde). Druckfestigkeit nach 28 Tagen ca. ≥ 60,0 N/mm², Biegezugfestigkeit ca. ≥ 6,5 N/mm². Nachbehandlung mit Wasser unmittelbar bei Verlust des feuchten Glanzes beginnen und über 1 Stunde mehrfach wiederholen; bei längeren Abbindezeiten, niedrigen Temperaturen oder Verzögerereinsatz längere Nachbehandlung."]}],
    verarbeitungMeta: [{"titel": "Besonderheiten", "text": "Schnellhärtend, schwundneutral und spannungsarm (Rissminimierung), Nachbehandlung nur mit Wasser. Polymer-modifiziert, faserverstärkt, sulfatbeständig, chloridfrei, frost-/taubeständig. Exzellente Haftung direkt ohne Haftbrücke. Einsetzbar innen und außen sowie in Nassbereichen, horizontal und vertikal. Gemäß DIN EN 1504-3, Qualität C35/45, Körnung 0 - 8 mm."}],
    kategorie: "schnellzement",
    ...
    technischeDaten: [
      ...
      { label: "Körnung", wert: "0–8 mm" },
      { label: "Druckfestigkeit (60 min)", wert: "> 19 N/mm²", norm: "DIN EN 12190" },
      { label: "Druckfestigkeit (28 d)", wert: "ca. ≥ 60 N/mm²", norm: "DIN EN 12190" },
      { label: "Biegezugfestigkeit (28 d)", wert: "ca. ≥ 6,5 N/mm²", norm: "DIN EN 12190" },
  ...
  },
  {
    ...
    verarbeitung: {"untergrundvorbereitung": "Verarbeitungs-, Umgebungs- und Untergrundtemperatur mindestens 5 Grad C. Alle Fugen aus dem Tragbeton uebernehmen, den Beton von aufgehenden Bauteilen (Waende, Stuetzen etc.) trennen.", "mischverhaeltnis": "Beispielrezeptur fuer Schnellbeton C40/50: Rapid Set Zement 360 kg, Gesteinskoernung A/B16 ca. 1900 kg, Wasser/Zementwert ca. 0,45. Frischbetonkonsistenz F3 bis F4. Gemischt wird direkt auf der Baustelle mit volumetrischen Misch-LKWs (z. B. Cemen Tech M-Series), die alle Komponenten getrennt bevorraten und vor Ort zu Frischbeton mischen; voll beladen ca. 8 m3 je LKW.", "schichtaufbau": "Rapid Set Concrete in gleichmaessiger Schichtdicke zuegig einbringen, verdichten, abziehen und glaetten. Oberflaechentextur herstellen, z. B. Besenstrich aufbringen.", "verarbeitungszeit": "Ca. 15 bis 30 Minuten, abhaengig von Rezeptur und Witterung. Hoehere Temperaturen verkuerzen, niedrigere verlaengern die Verarbeitungszeit. Konsistenz und Verarbeitungszeit sind ueber die hinterlegten Rezepturen vor Ort individuell einstellbar.", "aushaertezeit": "Schnelle Nutzung und Verkehrsfreigabe bereits zwei Stunden nach Einbau moeglich. Druckfestigkeit nach 2 Stunden mind. 20 MPa, nach 12 Stunden mind. 30 MPa, nach 28 Tagen mind. 45 MPa; Biegezugfestigkeit nach 5 Stunden mind. 3,0 MPa, nach 28 Tagen mind. 4,5 MPa.", "besonderheiten": "Im direkten Anschluss an den letzten Bearbeitungsschritt die frische Betonoberflaeche mit geeigneten Massnahmen vor Austrocknung schuetzen, z. B. Aufbringen von fluessigem, paraffinbasiertem Nachbehandlungsmittel."},
    kategorie: "schnellzement",
  ...
  },
  {
    ...
    name: "NEODUR HE 2",
    verarbeitung: {"untergrundvorbereitung": "Tragbeton mind. als C 25/30 gem. DIN EN 206 herstellen, kein Luftporen-Beton. Oberfläche höhengerecht innerhalb der Toleranzgrenze nach DIN 18202. Zur Zwischen-Nachbehandlung des Tragbetons empfehlen wir KOROCURE. Den frischen, soeben begehbaren Tragbeton mit einer Tellerglättmaschine abreiben.", "mischverhaeltnis": "Gebrauchsfertiger, zementgebundener Trockenbaustoff. Wird trocken eingestreut, kein Anmischen nötig.", "schichtaufbau": "Einstreuverfahren: NEODUR HE 2 trocken und gleichmäßig auftragen (z. B. mit Einstreuwagen). Materialverbrauch zementgrau ca. 3-5 kg/m², farbig ca. 5-6 kg/m². Nach Durchfeuchtung mit der Tellerglättmaschine einreiben; weiterer Auftrag möglich, solange der Trockenbaustoff vollständig durchfeuchtet. Anschließend porenschließend abscheiben und je nach gewünschter Oberflächenstruktur mit der Flügelglättmaschine glätten. Bei Stahlfaserbeton direkt nach Betoneinbau mit einem Spreader mechanisch applizierbar, anschließend verdichten und glätten wie beschrieben.", "aushaertezeit": "Vor zu rascher Austrocknung gem. DIN EN 13670 / DIN 1045-3 schützen; unterschiedliche Temperaturen beeinflussen Erstarrungs- und Erhärtungsverlauf.", "besonderheiten": "Verarbeitungs-, Umgebungs- und Untergrundtemperatur ≥ 5 °C. Nachbehandlung der Hartstoffeinstreuung mit KOROMINERAL CURE oder KOROTEX; bei geplanter Oberflächenvergütung, Beschichtung oder Markierung Nachbehandlung nur mit Folie. Fugenraster ist vom Planer vorzugeben."},
    kategorie: "estrich",
    bereich: "industrieboden",
    produktgruppe: "hartstoffeinstreuung",
    kurzbeschreibung: "Zementgebundener Trockenbaustoff für Industrieböden im Einstreuverfahren",
    ...
    technischeDaten: [
      ...
      { label: "Druckfestigkeit", wert: "70 N/mm²", norm: "DIN EN 13892-2" },
      { label: "Biegezugfestigkeit", wert: "9 N/mm²", norm: "DIN EN 13892-2" },
      { label: "Schleifverschleiß", wert: "≤ 8 cm³/50 cm²", norm: "DIN EN 13892-3" },
    ],
  ...
  },
  {
    ...
    name: "KORODUR 0/4",
    verarbeitung: {"untergrundvorbereitung": "Für die Untergrundvorbereitung gelten die Abschnitte des Datenblatts NEODUR HE 65 (Hartstoffestrich nach DIN 18560-7) bzw. NEODUR HE 3 (Einstreuverfahren nach DIN 18560-3/4).", "mischverhaeltnis": "1 Gewichtsteil Zement (CEM I 42,5 R) : 2 Gewichtsteile KORODUR 0/4 (MV 1:2). Als Hartstoffestrich mit Zement, ggf. Additiv KOROTAN und Wasser ca. 3 Minuten im Zwangsmischer anmischen; im Einstreuverfahren trocken mischen.", "schichtaufbau": "Hartstoffestrich (DIN 18560-7), Gruppe A: schwere Beanspruchung 15 mm (ca. 21 kg/m²), mittlere 10 mm (ca. 14 kg/m²), leichte 8 mm (ca. 12 kg/m²). Einstreuverfahren (DIN 18560-3/4): ca. 3,0 kg/m² Hartstoff und ca. 1,5 kg/m² Zement.", "aushaertezeit": "Erstarrungs- und Erhärtungsverlauf temperaturabhängig; keine feste Aushärtezeit im TDS angegeben. Nachbehandlung erforderlich (siehe Besonderheiten).", "besonderheiten": "Verarbeitungs-, Umgebungs- und Untergrundtemperatur mindestens 5 °C. Nachbehandlung: Hartstoffschicht vor zu rascher Austrocknung schützen (DIN EN 13670 / DIN 1045-3), z. B. mit KOROMINERAL CURE oder KOROTEX; bei anschließender Oberflächenvergütung, Beschichtung oder Markierung nur mit Folie nachbehandeln. Fugen: Fugenraster vom Planer vorgeben, alle Fugen im erhärteten Tragbeton in die Hartstoffschicht übernehmen, Hartstoffestrich von aufgehenden Bauteilen (Wände, Stützen) trennen. Trocken lagern."},
    kategorie: "sonstige",
    bereich: "industrieboden",
    produktgruppe: "hartstoffeinstreuung",
    ...
    normen: ["DIN 1100"],
    technischeDaten: [
      { label: "Hartstoffgruppe (DIN 1100)", wert: "A", norm: "DIN 1100" },
      { label: "Schleifverschleiß", wert: "≤ 5 cm³/50 cm²", norm: "DIN EN 13892-3" },
    ],
  ...
  },
  {
    ...
    name: "KORODUR VS 0/5",
    verarbeitung: {"untergrundvorbereitung": "Verarbeitungs-, Umgebungs- und Untergrundtemperatur ≥ 5 °C. Der Hartstoffestrich ist von aufgehenden Bauteilen (Wände, Stützen etc.) zu trennen; das Fugenraster gibt der Planer vor.", "mischverhaeltnis": "1 GT Zement : 2-3 GT KORODUR VS 0/5 (je nach Baustellengegebenheit). Mit Zement, ggf. Additiven und Wasserzugabe im Zwangsmischer ca. 3 Minuten anmischen.", "schichtaufbau": "Hartstoffverbrauch nach Beanspruchung (DIN 18560): schwer 15 mm / 21-24 kg/m², mittel 10 mm / 14-16 kg/m², leicht 8 mm / 12-13 kg/m². Einbau als Hartstoffestrich gem. DIN 18560-7.", "besonderheiten": "Nachbehandlung mit KOROMINERAL CURE oder KOROTEX; die Hartstoffschicht vor zu rascher Austrocknung gem. DIN EN 13670 / DIN 1045-3 schützen. Bei anschließender Oberflächenvergütung, Beschichtung oder Markierung nur mit Folie nachbehandeln. Weiterverarbeitung siehe Datenblatt NEODUR HE 65."},
    kategorie: "sonstige",
    bereich: "industrieboden",
    produktgruppe: "hartstoffestriche",
  ...
  },
  {
    ...
    verarbeitung: {"untergrundvorbereitung": "Das TDS gibt keine eigenen Untergrund-Schritte, sondern verweist auf das Datenblatt NEODUR HE 65 (Hartstoffestrich) bzw. NEODUR HE 3 (Einstreuung). Fugen: Fugenraster vom Planer vorgeben, alle Fugen im erhaerteten Tragbeton in die Hartstoffschicht uebernehmen, Hartstoffestrich von aufgehenden Bauteilen (Waende, Stuetzen) trennen.", "mischverhaeltnis": "1 GT Zement (CEM I 42,5 R) : 2 GT KORODUR WH-Spezial nach Gewichtsteilen (MV 1:2). Fuer die Hartstoffschicht mit Zement und ggf. Additiven (KOROTAN optional) sowie Wasser im Zwangsmischer je nach Verarbeitung ca. 3 Minuten anmischen. Fuer das Einstreuverfahren wird trocken gemischt.", "schichtaufbau": "Hartstoffestrich gem. DIN 18560-7, Gruppe A: schwer 15 mm ca. 22 kg/m2, mittel 10 mm ca. 15 kg/m2, leicht 8 mm ca. 13 kg/m2. Einstreuverfahren gem. DIN 18560-3/4: Trockenmischung ca. 3,0 kg/m2 bzw. Hartstoffverbrauch ca. 1,5 kg/m2.", "verarbeitungszeit": "Mischzeit im Zwangsmischer ca. 3 Minuten. Verarbeitungs-, Umgebungs- und Untergrundtemperatur mindestens 5 Grad C.", "aushaertezeit": "Kennwerte (C70 Druck-, F10 Biegezugfestigkeit) nach 28 Tagen. Keine konkrete Begeh-/Belastbarkeitszeit angegeben. Nachbehandlung: Hartstoffschicht vor zu rascher Austrocknung gem. DIN EN 13670 / DIN 1045-3 schuetzen, mit KOROMINERAL CURE oder KOROTEX. Bei anschliessender Oberflaechenverguetung, Beschichtung oder Markierung nur mit Folie nachbehandeln.", "besonderheiten": "Zwei Verarbeitungswege: als Hartstoffestrich (DIN 18560-7) oder im Einstreuverfahren (DIN 18560-3/4). Detaillierte Schritte zu Untergrund, Verarbeitung, Nachbehandlung und Fugen gemaess Datenblatt NEODUR HE 65 (Schicht) bzw. NEODUR HE 3 (Einstreuung). Rein mineralischer Hartstoff, kann optional mit Additiv KOROTAN gemischt werden."},
    kategorie: "sonstige",
    bereich: "industrieboden",
    produktgruppe: "hartstoffestriche",
    ...
    technischeDaten: [
      { label: "Hartstoffgruppe (DIN 1100)", wert: "A", norm: "DIN 1100" },
      { label: "Schleifverschleiß", wert: "≤ 3 cm³/50 cm²", norm: "DIN EN 13892-3" },
    ],
    besonderheiten: ["Hartstoff ohne Bindemittel"],
    zeitKategorie: "normal",
  },
  {
    ...
    verarbeitung: {"untergrundvorbereitung": "Untergrund, Verarbeitung, Nachbehandlung und Fugen gemäß Datenblatt NEODUR HE 65 (bei Verarbeitung als Hartstoffestrich) bzw. NEODUR HE 3 (im Einstreuverfahren). Verarbeitungs-, Umgebungs- und Untergrundtemperatur mindestens 5 °C.", "mischverhaeltnis": "KORODUR WH-metallisch mit Zement (CEM I 42,5 R) und optional dem Additiv KOROTAN mischen. Hartstoffestrich (Schicht): 1 GT Zement : 3 GT KORODUR WH-metallisch. Einstreuung: 1 GT Zement : 2 GT KORODUR WH-metallisch.", "schichtaufbau": "Als Hartstoffestrich gem. DIN 18560-7: Nenndicke 8 mm bei schwerer Beanspruchung (ca. 21 kg/m²), 6 mm bei mittlerer Beanspruchung (ca. 16 kg/m²). Im Einstreuverfahren gem. DIN 18560-3/4: Trockenmischung ca. 4,0 kg/m², Zement ca. 2,0 kg/m².", "verarbeitungszeit": "Als Hartstoffestrich mit Zement, ggf. Additiven und Wasser im Zwangsmischer je nach Verarbeitungsart ca. 3 Minuten anmischen; für die Einstreuung trocken mischen.", "besonderheiten": "Nachbehandlung: Hartstoffschicht vor zu rascher Austrocknung gem. DIN EN 13670 / DIN 1045-3 schützen; wir empfehlen KOROMINERAL CURE oder KOROTEX. Bei geplanter Oberflächenvergütung, Beschichtung oder Markierung Nachbehandlung nur mit Folie. Fugen: Fugenraster vom Planer vorgeben; alle Fugen im erhärteten Tragbeton in die Hartstoffschicht übernehmen; Hartstoffestrich von aufgehenden Bauteilen (Wände, Stützen) trennen."},
    kategorie: "sonstige",
    bereich: "industrieboden",
    produktgruppe: "hartstoffeinstreuung",
    ...
    normen: ["DIN 1100"],
    technischeDaten: [
      { label: "Hartstoffgruppe (DIN 1100)", wert: "M", norm: "DIN 1100" },
      { label: "Schleifverschleiß", wert: "≤ 3 cm³/50 cm²", norm: "DIN EN 13892-3" },
    ],
  ...
  },
  {
    ...
    verarbeitung: {"untergrundvorbereitung": "Untergrund je nach Verfahren gemäß dem jeweiligen Datenblatt vorbereiten: Hartstoffestrich (DIN 18560-7) nach NEODUR HE 65, Einstreuverfahren (DIN 18560-3/4) nach NEODUR HE 3. Fugen des erhärteten Tragbetons müssen in die Hartstoffschicht übernommen werden; der Hartstoffestrich ist von aufgehenden Bauteilen (Wände, Stützen) zu trennen.", "mischverhaeltnis": "Mischungsverhältnis nach Gewichtsteilen 1:2 (1 GT Zement : 2 GT Diamantbeton). Schichtverfahren: mit Zement, ggf. Additiv KOROTAN und Wasser anmischen. Einstreuverfahren: Trockenmischung ca. 3,0 kg/m2 Diamantbeton + ca. 1,5 kg/m2 Zement.", "schichtaufbau": "Hartstoffestrich (DIN 18560-7), Nenndicke und Verbrauch je Hartstoffgruppe KS: Gruppe I (schwer) 6 mm / ca. 9,5 kg/m2, Gruppe II (mittel) 5 mm / ca. 8,0 kg/m2, Gruppe III (leicht) 4 mm / ca. 6,5 kg/m2. Alternativ Einstreuverfahren (DIN 18560-3/4) mit ca. 3,0 kg/m2.", "verarbeitungszeit": "Im Zwangsmischer je nach Art der Verarbeitung ca. 3 Minuten anmischen (Schichtverfahren mit Zement, ggf. Additiv und Wasser).", "besonderheiten": "Nachbehandlung: Die Hartstoffschicht ist vor rascher Austrocknung gemaess DIN EN 13670 / DIN 1045-3 zu schuetzen, empfohlen mit KOROMINERAL CURE oder KOROTEX. Bei geplanter Oberflaechenverguetung, Beschichtung oder Markierung Nachbehandlung nur mit Folie. Unterschiedliche Temperaturen beeinflussen den Erstarrungs- bzw. Erhaertungsverlauf. Weitere Verarbeitung (Untergrund, Auftrag, Nachbehandlung, Fugen) gemaess Datenblatt NEODUR HE 65 (Schichtverfahren) bzw. NEODUR HE 3 (Einstreuverfahren)."},
    kategorie: "sonstige",
    bereich: "industrieboden",
    produktgruppe: "hartstoffestriche",
    ...
    normen: ["DIN 1100"],
    technischeDaten: [
      { label: "Hartstoffgruppe (DIN 1100)", wert: "KS", norm: "DIN 1100" },
      { label: "Schleifverschleiß", wert: "≤ 1,5 cm³/50 cm²", norm: "DIN 1100" },
    ],
  ...
  },
  {
    ...
    technischeDaten: [
      ...
      { label: "Druckfestigkeit (DIN EN 13892-2)", wert: "nach 1 Tag ca. 20 N/mm², nach 28 Tagen ca. 40 N/mm²", norm: "DIN EN 13892-2" },
      { label: "Biegezugfestigkeit (DIN EN 13892-2)", wert: "nach 1 Tag ca. 4 N/mm², nach 28 Tagen ca. 6 N/mm²", norm: "DIN EN 13892-2" },
      { label: "Schwindklasse (DIN 18560-1)", wert: "SW 1, schwindarm (< 0,2 mm/m)", norm: "DIN 18560-1" },
  ...
  },
  {
    ...
    verarbeitungModi: [{"titel": "Schicht auf erhärteten Beton", "schritte": ["Untergrund: Zementären Untergrund durch Fräsen und/oder Kugelstrahlen vorbereiten. Risse, Ausbrüche und schadhafte Fugen fachgerecht instand setzen. Untergrund tragfähig, fest, sauber, trocken und frei von losen Teilen, Ölen, Fetten und haftungsmindernden Verunreinigungen. Oberflächenzugfestigkeit ohne Fahrbeanspruchung >= 1,0 N/mm2, mit Fahrbeanspruchung oder im Außenbereich >= 1,5 N/mm2. Auf dem vorbereiteten Untergrund KORODUR PC Grundierung aufbringen. Es gelten DIN 18365 und DIN 18560.", "Mischen: ca. 4,0 l Wasser pro 25-kg-Gebinde. Mit Mischquirl (mind. 650 UpM) oder Zwangsmischer 3 bis 5 Minuten klumpenfrei und homogen anmischen.", "Auftrag: Schichtdicke 5 bis 50 mm auf grundiertem Untergrund. NEODUR Level AU muss grundsätzlich belegt werden. Materialverbrauch ca. 1,7 kg/m2 pro mm Schichtstärke.", "Verarbeitungszeit: ca. 30 Minuten bei 20 °C. Gemischtes Material innerhalb 30 Minuten applizieren.", "Aushärtung: Begehbar nach ca. 3 bis 4 Stunden. Verlegung bei feuchtigkeitsunempfindlichen Böden nach ca. 24 Stunden, bei feuchtigkeitsempfindlichen Böden nach ca. 48 Stunden (je nach Temperatur)."]}],
    verarbeitungMeta: [{"titel": "Besonderheiten", "text": "Maschinelle Verarbeitung mit Schneckenpumpen oder Mischpumpen möglich (Ausbreitmaß gem. DIN EN 12706 = 12 bis 13 cm); keine luftreiche Mischtechnik verwenden. Gleichmäßiges Applizieren mit geeignetem Rakel empfohlen, Lufteinschlüsse mit Stachelwalze entfernen. Alle Fugen im Untergrund übernehmen, von aufgehenden Bauteilen (Wände, Stützen) trennen. Bei 20 °C keine Nachbehandlung nötig; im Außenbereich frisch abgebundene Oberfläche mit feinem Wassernebel behandeln (mind. 1 Stunde). Trocken lagern, Haltbarkeit ca. 6 Monate."}],
    kategorie: "estrich",
    bereich: "industrieboden",
    produktgruppe: "selbstverlaufend",
    ...
    technischeDaten: [
      ...
      { label: "Druckfestigkeit", wert: "nach 28 Tagen ≥ 33 N/mm²", norm: "DIN EN 13892-2" },
  ...
  },
  {
    ...
    name: "KORODUR HB 5",
    verarbeitungModi: [{"titel": "Schicht auf erhärteten Beton (1-2  mm)", "schritte": ["Untergrund: Tragbeton (mind. C25/30, Oberflächenzugfestigkeit ≥ 1,5 N/mm²) vorbereiten, z. B. durch Fräsen oder Kugelstrahlen. Oberfläche rissfrei, eben, rau und offenporig, frei von losen/mürben Bestandteilen und Feinstmörtelanreicherungen. Anforderungen DIN 18365 und DIN 18560, Ebenheit nach DIN 18202 Tab. 3 Zeile 3. Tragbeton einen Tag vor der Verlegung gründlich vornässen, Pfützenbildung vermeiden.", "Mischen: Wasserzugabe ca. 5,5 l je 25-kg-Gebinde. Mit langsam laufendem Quirl mind. 2 bis 3 Minuten mischen, bis eine weichbreiige Schlämme entsteht. Überwässertes Material nicht verwenden.", "Auftrag: Fertig gemischte Haftbrücke ca. 1 bis 2 mm dick mit hartem Straßenbesen auf den vorbereiteten, mattfeucht angetrockneten Untergrund aufbürsten. Materialverbrauch ca. 2,0 kg/m²/mm. Estrich sofort frisch-in-frisch auf die noch frische Haftbrücke verlegen."]}],
    verarbeitungMeta: [{"titel": "Besonderheiten", "text": "Verarbeitungs-, Umgebungs- und Untergrundtemperatur ≥ 5 °C. Auf keine Blassfärbung/Überwässerung achten. Estrich frisch-in-frisch verlegen, um vorzeitige Austrocknung der Haftbrücke zu vermeiden. Alle Fugen im Untergrund übernehmen, Verbundestrich von aufgehenden Bauteilen (Wände, Stützen etc.) trennen. Für innen und außen. Eingefärbt zur Sichtkontrolle."}],
    kategorie: "grundierung",
    bereich: "industrieboden",
    // #306/#308: Begleitprodukt auch im Infrastruktur-Bereich.
    produktgruppe: "untergrund-haftbruecken",
  ...
  },
  {
    ...
    name: "KORODUR TXPK",
    verarbeitung: {"untergrundvorbereitung": "Untergrund vor der Verlegung durch Fräsen und/oder Kugelstrahlen vorbereiten. Risse, Ausbrüche und schadhafte Fugen fachgerecht instand setzen. Der Untergrund muss tragfähig, fest, sauber, trocken und frei von losen Teilen, Ölen, Fetten und haftungsmindernden Verunreinigungen sein. Oberflächenzugfestigkeit mind. 1,5 N/mm², Betonrestfeuchte max. 6 M.-%. Untergrundtemperatur 12–30 °C.", "mischverhaeltnis": "A : B = 100 : 38 (2,63 : 1). Komponenten A + B mit langsam laufendem Rührwerk (300–400 U/min) ca. 3 Minuten homogen mischen, umtopfen und erneut ca. 1 Minute mischen. Materialtemperatur mind. 15 °C.", "schichtaufbau": "Gemischtes Material sofort mit Gummirakel auftragen und mit Farbroller intensiv in den Untergrund einarbeiten. Anschließend vollflächig mit feuergetrocknetem Quarzsand (Körnung 0,4–0,8 mm) abstreuen. Bei feuchten oder rückwärtig durchfeuchteten Flächen ist ein 2. Arbeitsgang (doppelte Auftragsmenge) erforderlich. Materialverbrauch ca. 400–500 g/m² je nach Saugfähigkeit.", "verarbeitungszeit": "12 °C ca. 35 Minuten, 23 °C ca. 25 Minuten, 30 °C ca. 10 Minuten.", "aushaertezeit": "Wartezeit bis zum nächsten Arbeitsgang: 12 °C 16–36 Stunden, 23 °C 5–24 Stunden, 30 °C 4–24 Stunden.", "besonderheiten": "Vor, während und nach der Applikation auf den Taupunktabstand (+3 °C) achten. Grundierungsarbeiten nur bei gleichbleibenden oder fallenden Temperaturen ausführen, da es sonst zu Blasenbildung und Undichtigkeit kommt. Feuchte Flächen dürfen mattfeucht sein, aber keinen sichtbaren Wasserfilm bzw. kein Porenwasser aufweisen. UV-Strahlung führt zu einer Farbtonveränderung. Nach Aushärtung physiologisch unbedenklich, geprüft gem. AgBB, praktisch emissionsfrei."},
    kategorie: "grundierung",
    bereich: "industrieboden",
    // #306/#308: Begleitprodukt auch im Infrastruktur-Bereich.
    produktgruppe: "untergrund-haftbruecken",
  ...
  },
  {
    ...
    name: "KORODUR DUROP",
    verarbeitung: {"schichtaufbau": "Als Füll- und Abstreumaterial in verschiedenen Dicken gemäß Angabe des jeweiligen Kunstharzherstellers/-lieferanten verarbeitbar, für nahezu alle Kunstharzsysteme geeignet. Bei optischen Anforderungen empfehlen wir eine (ggf. farbige) Kopfversiegelung für ein gleichmäßiges Erscheinungsbild und verbesserte Nutzungs-/Reinigungsfähigkeit.", "besonderheiten": "Das Anlegen einer Testfläche empfehlen wir. Materialfarbe dunkelanthrazit, je nach Rohstoffbeschaffenheit. Lieferbar in vier Körnungen: 0,5-1, 1-2, 2-3 und 2-5 mm. Lieferform 25 kg Papierspezialverpackung, trocken lagern."},
    kategorie: "sonstige",
    bereich: "infrastruktur",
  ...
  },
  {
    ...
    name: "KORODUR Robust",
    verarbeitung: {"untergrundvorbereitung": "Untergrundvorbereitung mittels Kugelstrahltechnik. Verbund auf erhärtetem, gesäubertem, griffigem und vorgenässtem Tragbeton, mindestens C25/30.", "schichtaufbau": "Einschichtig im Verbund, Schichtdicke 8 bis 12 mm, Körnung 0 bis 3 mm. Schrittfolge Sanierung: 1. Untergrundvorbereitung mittels Kugelstrahltechnik, 2. Grundierung gem. WFS-System, 3. Einbau Spezial WFS Epoxidharz-Estrich + KORODUR Robust 0/3 Hartkornmischung, 4. Porenspachtelung, 5. Abstreuen im Überschuss einer Harzschicht mit Spezialkorn, 6. chemikalienbeständige Versiegelung gem. WFS-System, 7. Bedarfsposition: zusätzliche Mattversiegelung R 12 gem. WFS-System.", "besonderheiten": "Fugenlos, verschleißfest, stoßfest, zähhart, trittsicher, nassraumtauglich, verbesserte Chemikalienbeständigkeit. Rutschhemmung R 11 (R 12). Lieferform 25 kg Spezialverpackung, trocken lagern."},
    kategorie: "sonstige",
    bereich: "industrieboden",
    produktgruppe: "kunstharz-hartstoffe",
  ...
  },
  {
    ...
    verarbeitung: {"untergrundvorbereitung": "Tragbeton mind. C 25/30, Oberflaechenzugfestigkeit >= 1,5 N/mm2. Untergrund z. B. durch Fraesen oder Kugelstrahlen vorbereiten: rissefrei, eben, frei von losen und muerben Bestandteilen und Feinstmoertelanreicherungen, rau und offenporig. Anforderungen nach DIN 18365 und DIN 18560. Bei normalen Bedingungen kein Vornaessen noetig, nur bei stark saugenden Untergruenden zusaetzliches, mattfeuchtes Vornaessen sinnvoll.", "mischverhaeltnis": "Einkomponentig, gebrauchsfertig. Unverduennt verarbeiten, vor Applikation stets gut durchruehren.", "schichtaufbau": "Unverduennt und gleichmaessig deckend aufspruehen (handelsuebliche Spritzgeraete mit passenden Duesen), Pfuetzenbildung vermeiden. Alternativ Auftrag mit langfloriger Lammfellrolle, dabei hoeherer Verbrauch. Materialverbrauch ca. 150 bis 250 g/m2 je nach Saugfaehigkeit. Vor der anschliessenden Beschichtung mit Haftbruecke und Hartstoffestrich muss uniPrimer abgetrocknet sein.", "aushaertezeit": "Schnell erhaertend. Vor dem Weiterbeschichten muss uniPrimer abgetrocknet sein (kein konkreter Zeitwert im TDS).", "besonderheiten": "Verarbeitungs-, Umgebungs- und Untergrundtemperatur >= 5 Grad C. Materialueberschuss vermeiden. uniPrimer ersetzt nicht die Systemhaftbruecke KORODUR HB 5 oder HB 5 rapid."},
    kategorie: "grundierung",
    bereich: "industrieboden",
    aussenbereich: true,
    // #306/#308: Begleitprodukt auch im Infrastruktur-Bereich.
  ...
  },
  {
    ...
    name: "KOROMINERAL Li+",
    verarbeitung: {"untergrundvorbereitung": "Untergrund trocken, fest, sauber, saugfaehig und frei von Oel, Fett und sonstigen trennmittelwirkenden Verunreinigungen. Maschinelle Nassreinigung ist zwingend erforderlich. Oberflaechentemperatur 5 bis 35 Grad C.", "mischverhaeltnis": "Gebrauchsfertig geliefert, wird unverduennt verarbeitet (kein Anmischen).", "schichtaufbau": "Unverduennt in einem Arbeitsgang bis zur Saettigung mit Airless-Spritze (Duese 0,2 bis 0,3) auftragen, unmittelbar Hand in Hand mit kurzhaariger Polyamid-Walze nachrollen oder mit Microfasermop nacharbeiten. Pfuetzenbildung vermeiden. Bei stark saugenden Boeden zweimaliger Auftrag empfohlen, zweiter Auftrag feucht in feucht. Materialverbrauch ca. 100 bis 200 g/m2 je nach Saugfaehigkeit.", "verarbeitungszeit": "Materialueberschuesse nach ca. 20 Minuten mit Scheuersaugmaschine aufnehmen oder mit Polierpad einarbeiten. Ueberschuessiges Material vor dem Antrocknen entfernen.", "aushaertezeit": "Trocknungszeit ca. 1 bis 2 Stunden. Direkte Feuchtigkeitseinwirkung bis zur vollstaendigen Aushaertung vermeiden.", "besonderheiten": "Direkte Sonneneinstrahlung waehrend der Verarbeitung vermeiden. Angrenzende Flaechen gegen Spritzer schuetzen. Geraetereinigung mit Wasser. Wir empfehlen das Anlegen einer Musterflaeche, um oertliche Gegebenheiten zu erfassen."},
    kategorie: "beschichtung",
    bereich: "industrieboden",
    zusatzBereiche: ["infrastruktur"],
    // #306/#308: Begleitprodukt auch im Infrastruktur-Bereich.
  ...
  },
  {
    ...
    name: "KOROCLEAN",
    verarbeitung: {"untergrundvorbereitung": "Anwendbar auf frisch geglättete KORODUR- und NEODUR-Hartstoff-Industrieestriche sowie auf alle sonstigen zementären Industrieböden, in allen Verwendungsbereichen.", "schichtaufbau": "KOROCLEAN ist ein Politur-Verfahren: Die beim Glätten entstehende Zementhaut wird schonend entfernt, indem die Zementleimhaut durch Polieren im µm-Bereich abgetragen wird. Anders als beim Schleifen wird der Kornquerschnitt nicht freigelegt, das Porengefüge wird entfernt. Das Oberflächenfinish führen wir je nach Kundenwunsch von seidenmatt bis hochglänzend aus.", "besonderheiten": "Ergebnis ist ein staubfreier, reinigungsfreundlicher Boden mit weiter erhöhter Abriebfestigkeit, gleichmäßiger Farb- und Texturerscheinung und reduzierten farblichen Irritationen. Bei Bedarf lässt sich die Reinigungsfähigkeit durch eine zusätzliche Imprägnierung (KOROPOX, KOROMINERAL oder KOROMINERAL Li+, siehe jeweiliges Datenblatt) weiter steigern; die Fleckbildung wird dadurch deutlich verringert."},
    kategorie: "sonstige",
    bereich: "industrieboden",
  ...
  },
  {
    ...
    verarbeitung: {"untergrundvorbereitung": "Tragbeton mind. C 25/30, Oberflaechenzugfestigkeit >= 1,5 N/mm2. Oberflaeche z. B. durch Fraesen und Kugelstrahlen vorbereiten: rissefrei, eben, frei von losen und muerben Bestandteilen und Feinstmoertelanreicherungen, rau und offenporig. Anforderungen nach DIN 18365 und DIN 18560, Ebenheit nach DIN 18202 Tab. 3 Zeile 3. Tragbeton einen Tag vor der Verlegung gruendlich vornaessen, Pfuetzenbildung vermeiden. Auf die mattfeuchte Oberflaeche die Haftbruecke KORODUR HB 5 auftragen.", "mischverhaeltnis": "3 Gewichtsteile Hartstoff (KORODUR 0/4 / KORODUR VS 0/5 / KORODUR WH-Spezial) : 1 Gewichtsteil Zement CEM I 42,5 R : 0,02 Gewichtsteile KOROTAN Additiv (max. 2 % vom Zementgewicht). Wasserzugabe jeweils bis zum Erreichen einer steif/plastischen Konsistenz. Im Zwangsmischer mischen.", "schichtaufbau": "Einschichtiger Hartstoffestrich im Verbund, Nenndicke 15 mm, auf erhaertetem Tragbeton. Aufbau: Tragbeton, Haftbruecke KORODUR HB 5, KORODUR-KOROTAN Hartstoffestrich. Weitgehend fugenlose Verlegung.", "verarbeitungszeit": "Ca. 3 Minuten im Zwangsmischer mischen, dann auf die frische Haftbruecke KORODUR HB 5 aufbringen (frisch in frisch).", "aushaertezeit": "Erstarrungs- und Erhaertungsverlauf ist temperaturabhaengig. Hartstoffestrich vor zu rascher Austrocknung gem. DIN EN 13670 / DIN 1045-3 schuetzen. Nachbehandlung mit KOROMINERAL CURE oder KOROTEX; bei geplanter Oberflaechenverguetung, Beschichtung oder Markierung nur mit Folie nachbehandeln.", "besonderheiten": "Ueber Lehren (Rundeisen) per Alu-Richtscheit oder Ruettelbohle abziehen, zeitgerecht mit Tellerglaettmaschine porenschliessend abreiben und je nach verlangter Oberflaechenstruktur mit Fluegelglaettmaschine glaetten. Alle Fugen im Tragbeton in der Hartstoffschicht uebernehmen. Estrich von aufgehenden Bauteilen (Waende, Stuetzen) trennen."},
    kategorie: "sonstige",
    bereich: "industrieboden",
    produktgruppe: "systeme",
  ...
  // Zuordnung: docs/website-migration/zuordnung-sichtestrich-microtop.md
  {
    ...
    name: "GRANIDUR",
    verarbeitungModi: [{"titel": "Schicht auf erhärteten Beton (15-25 mm)", "schritte": ["Untergrund: Zementären Untergrund als Tragbeton C25/30 oder Tragestrich mindestens CT-C40-F6 vorbereiten, z. B. durch Fräsen und/oder Kugelstrahlen. Risse, Ausbrüche und schadhafte Fugen fachgerecht instand setzen; Fugen im Untergrund übernehmen. Oberflächenzugfestigkeit >= 1,5 N/mm² (befahrene Flächen) bzw. >= 1,0 N/mm² (nicht befahren). Untergrund tragfähig, fest, sauber, trocken, frei von losen Teilen, Ölen und haftungsmindernden Verunreinigungen (DIN 18365, DIN 18560-3). Tragbeton mit KORODUR uniPrimer grundieren oder einen Tag vor Verlegung gründlich vornässen, Pfützenbildung vermeiden.", "Mischen: Wasserzugabe: GRANIDUR 05 ca. 2,50 l / 25 kg Gebinde, GRANIDUR 08 ca. 2,25 l / 25 kg Gebinde. GRANIDUR mit vorgegebener Wassermenge ca. 3 Minuten in plastischer Konsistenz mischen. Materialverbrauch ca. 2,1 kg pro m² und mm Schichtstärke.", "Auftrag: Ein- oder zweischichtig gemäß DIN 18560-2/-3/-4. Auf die mattfeuchte Oberfläche KORODUR HB 5 Haftbrücke systemkonform aufbringen, GRANIDUR frisch auf frisch auf die noch feuchte Haftbrücke aufbringen, fluchtgerecht abreiben und zeitgerecht mit Tellerglättmaschine porenschließend abreiben und glätten (Flügelglättmaschine). Schichtdicke 15 bis max. 70 mm je nach Verlegeart und Konstruktion.", "Verarbeitungszeit: Verarbeitungs-, Umgebungs- und Untergrundtemperatur >= 5 °C. Frisch auf frisch verarbeiten (auf die noch feuchte Haftbrücke). GRANIDUR 05 auch als schnellhärtende Variante GRANIDUR 05 rapid lieferbar.", "Aushärtung: Druckfestigkeit nach 28 Tagen: GRANIDUR 05 C45, GRANIDUR 08 C35 (DIN EN 13892-2). Sichtestrich vor zu rascher Austrocknung gem. DIN EN 13670 / DIN 1045-3 schützen, zur Nachbehandlung geeignete Abdeckungen (z. B. 400 g Malerpappen) verwenden."]}],
    verarbeitungMeta: [{"titel": "Besonderheiten", "text": "Schleifen/Polieren mit bis zu 5 Schleifgängen (Grob-, Mittel-, Feinschliff) bis zur gewünschten Terrazzooptik, nach jedem Gang nass reinigen. Fugenraster vom Planer; alle Untergrundfugen in die Sichtestrichschicht übernehmen, von aufgehenden Bauteilen trennen. Nach Abtrocknung und Erhärtung porentief reinigen und einpflegen. Farbige Produkte aus Naturrohstoffen: Farbschwankungen möglich, Probefläche empfohlen; bei farbigen/hellen Sichtestrichen Kunststofflügel statt Aluminium verwenden. Feine Rissbildungen und Schwindverformungen sind systembedingt und kein Mangel. Lagerung trocken wie Zement, Haltbarkeit ca. 6 Monate."}],
    kategorie: "estrich",
    bereich: "industrieboden",
    ...
    normen: ["DIN EN 13813"],
    technischeDaten: [
      { label: "Druckfestigkeit (GRANIDUR 05)", wert: "45 N/mm²", norm: "DIN EN 13892-2" },
      { label: "Biegezugfestigkeit (GRANIDUR 05)", wert: "6 N/mm²", norm: "DIN EN 13892-2" },
      { label: "Druckfestigkeit (GRANIDUR 08)", wert: "35 N/mm²", norm: "DIN EN 13892-2" },
      { label: "Biegezugfestigkeit (GRANIDUR 08)", wert: "5 N/mm²", norm: "DIN EN 13892-2" },
    ],
    besonderheiten: [
  ...
  },
  {
    ...
    verarbeitungModi: [{"titel": "Schicht auf erhärteten Beton (15 mm)", "schritte": ["Untergrund: Zementären Untergrund als Tragbeton C25/30 oder Tragestrich mind. CT-C40-F6 vorbereiten (z. B. Fräsen und/oder Kugelstrahlen). Risse, Ausbrüche und schadhafte Fugen fachgerecht instand setzen. Oberflächenzugfestigkeit mind. 1,5 N/mm² bei befahrenen bzw. mind. 1,0 N/mm² bei nicht befahrenen Flächen. Untergrund tragfähig, fest, sauber, trocken und frei von losen Teilen, Ölen und Fetten (DIN 18365, DIN 18560-3). Fugen im Untergrund übernehmen. Tragbeton oder Tragestrich mit KORODUR uniPrimer vorbehandeln oder alternativ einen Tag vor der Verlegung gründlich vornässen, Pfützenbildung vermeiden. Tragestrich nur schwundarme Schnellestrichsysteme (KORODUR FSCem Screed / FSCem) in CT-C40-F6, Schichtdicke mind. 65 mm.", "Mischen: Wasserzugabe ca. 2,5 l pro 25-kg-Gebinde. Material mit der vorgegebenen Wassermenge in plastischer Konsistenz ca. 3 Minuten mischen.", "Auftrag: Verbundestrich auf erhärtetem Beton mit KORODUR HB 5 Haftbrücke (bei BIANCO KORODUR HB 5 verwenden). Mittlere Schichtdicke 15 mm, Materialverbrauch ca. 2,1 kg/m² je mm Schichtstärke. HB 5 auf die mattfeuchte Oberfläche systemkonform aufbringen, GRANIDUR frisch in frisch auf die noch feuchte Haftbrücke aufbringen, fluchtgerecht abziehen und zeitgerecht mittels Tellerglättmaschine porenschließend abreiben und mit Flügelglättmaschine glätten.", "Verarbeitungszeit: Verarbeitungs-, Umgebungs- und Untergrundtemperatur mind. 5 °C. GRANIDUR frisch in frisch auf die noch feuchte Haftbrücke aufbringen.", "Aushärtung: Vor rascher Austrocknung schützen (DIN EN 13670 / DIN 1045-3), zur Nachbehandlung geeignete Abdeckungen (z. B. 400-g-Malerpappen) verwenden. Druck- und Biegezugfestigkeit (C45 / F6) nach 28 Tagen. Nach ausreichender Abtrocknung und Erhärtung Fläche reinigen und einpflegen. Schleifen mit bis zu 5 Schleifgängen (Grob-, Mittel- und Feinschliff) bis zur gewünschten Optik."]}],
    verarbeitungMeta: [{"titel": "Besonderheiten", "text": "Farbschwankungen aus Naturrohstoffen sind möglich, Probefläche vorab empfohlen. Kontakt mit Aluminium-Werkzeugen vermeiden (Verfärbungsgefahr); bei hellen Sichtestrichen keine Kunststoffflügel einsetzen. Feine Rissbildungen bzw. Krakeleerisse und Schwindverformungen sind systembedingt und stellen keinen Mangel dar. Fugenraster vom Planer vorzugeben, Fugen aus dem Tragbeton/-tragestrich übernehmen, Sichtestrich von aufgehenden Bauteilen trennen."}],
    kategorie: "estrich",
    bereich: "industrieboden",
    produktgruppe: "geschliffen",
    ...
    technischeDaten: [
      ...
      { label: "Druckfestigkeit", wert: "45 N/mm²", norm: "DIN EN 13892-2" },
      { label: "Biegezugfestigkeit", wert: "6 N/mm²", norm: "DIN EN 13892-2" },
    ],
    besonderheiten: [
  ...
  },
  {
    ...
    verarbeitungModi: [{"titel": "Schicht auf erhärteten Beton (15-25 mm)", "schritte": ["Untergrund: Zementärer Untergrund als Tragbeton C25/30 oder Tragestrich mind. CT-C40-F6, vorbereitet z. B. durch Fräsen und/oder Kugelstrahlen. Oberflächenzugfestigkeit ≥ 1,5 N/mm² (befahrene Flächen) bzw. ≥ 1,0 N/mm² (nicht befahren). Untergrund tragfähig, fest, sauber, trocken, frei von losen Teilen, Ölen und Fetten. Risse, Ausbrüche und schadhafte Fugen instand setzen, Fugen übernehmen. Es gelten DIN 18365 und DIN 18560-3. Vorbehandlung mit Universalgrundierung KORODUR uniPrimer oder alternativ einen Tag vor der Verlegung gründlich vornässen (keine Pfützenbildung).", "Mischen: Wasserzugabe je 25-kg-Gebinde: KCF 05 ca. 2,50 l, KCF 08 ca. 2,25 l. Trockenbaustoff mit der vorgegebenen Wassermenge in plastischer Konsistenz ca. 3 Minuten mischen.", "Auftrag: Ein- oder zweischichtig verlegt gemäß DIN 18560-2/-3/-4. Auf die mattfeuchte Oberfläche KORODUR HB 5 Haftbrücke systemkonform aufbringen, Frischmörtel frisch auf frisch auf die noch feuchte Haftbrücke aufbringen. Schichtdicke je nach Verlegeart: im Verbund (DIN 18560-3) KCF 05 15-25 mm, auf Trennschicht (DIN 18560-4) KCF 08 25-50 mm, auf Dämmschicht (DIN 18560-2) KCF 08 35-70 bzw. 45-70 mm.", "Verarbeitungszeit: Verarbeitungs-, Umgebungs- und Untergrundtemperatur ≥ 5 °C. Nach ca. 3 Minuten Mischen frisch aufbringen, zeitgerecht mittels Tellerglättmaschine porenschließend abreiben und wiederholt maschinell glätten (Flügelglättmaschine), bis sich eine glänzende Struktur einstellt. Randbereiche gesondert von Hand glätten.", "Aushärtung: Druck- und Biegezugfestigkeit nach 28 Tagen (KCF 05: C45/F6, KCF 08: C35/F5). Sichtestrich vor zu rascher Austrocknung schützen gem. DIN EN 13670 / DIN 1045-3; zur Nachbehandlung geeignete Abdeckungen (z. B. 400 g Malerpappe) verwenden. KCF 05 auch als schnellhärtende Variante KCF 05 rapid (ternäres Bindemittel) lieferbar."]}],
    verarbeitungMeta: [{"titel": "Besonderheiten", "text": "Als Tragbeton nur Betone ≥ C25/30, als Tragestrich nur schwundarme Schnellestrichsysteme auf ternärer Bindemittelbasis (KORODUR FSCem Screed / FSCem) zulässig. Farbige Produkte aus Naturrohstoffen, Farbschwankungen und Abweichungen vom Originalfarbton möglich; Probefläche empfohlen. Für farbige, helle Sichtestriche Kunststoffflügel einsetzen, Kontakt mit Aluminiumwerkzeugen vermeiden (Verfärbungen). Feine Rissbildungen (Krakeleerisse) und Schwindverformungen sind systembedingt nicht grundsätzlich vermeidbar und kein Mangel. Fugenraster vom Planer vorgeben; Sichtestrich von aufgehenden Bauteilen trennen."}],
    kategorie: "estrich",
    bereich: "industrieboden",
    ...
    technischeDaten: [
      { label: "Schleifverschleiß", wert: "≤ 5 cm³/50 cm²", norm: "DIN EN 13892-3" },
      { label: "Druckfestigkeit (KCF 05)", wert: "45 N/mm²", norm: "DIN EN 13892-2" },
      { label: "Biegezugfestigkeit (KCF 05)", wert: "6 N/mm²", norm: "DIN EN 13892-2" },
      { label: "Druckfestigkeit (KCF 08)", wert: "35 N/mm²", norm: "DIN EN 13892-2" },
      { label: "Biegezugfestigkeit (KCF 08)", wert: "5 N/mm²", norm: "DIN EN 13892-2" },
    ],
    besonderheiten: [
      "Lieferbar in zementgrau, weitere Farben auf Anfrage",
  ...
  },
  {
    ...
    name: "TRU PC",
    verarbeitungModi: [{"titel": "Schicht auf erhärteten Beton (10-35 mm)", "schritte": ["Untergrund: Zementären Untergrund als Tragbeton C25/30 oder Tragestrich mindestens CT-C35-F5 vorbereiten (z. B. Fräsen, Kugelstrahlen). Risse, Ausbrüche und schadhafte Fugen fachgerecht instand setzen. Untergrund muss tragfähig, fest, sauber, trocken und frei von losen Teilen, Ölen, Fetten und haftungsmindernden Verunreinigungen sein. Oberflächenzugfestigkeit mindestens 1,5 N/mm² (befahren) bzw. 1,0 N/mm² (nicht befahren). Anforderungen DIN 18365 und DIN 18560-3, Fugen im Untergrund übernehmen. Grundierung mit 2-komponentiger Epoxidharz-Grundierung KORODUR TXPK, anschließend mit feuergetrocknetem Quarzsand Körnung 0,4-0,8 mm satt absanden.", "Mischen: Wasserzugabe ca. 3,5-3,8 l je 27,2 kg Gebinde. Mischzeit 3-5 Minuten bis zur klumpenfreien Konsistenz, geeignete Mischtechnik mit mind. 650 UpM (z. B. Hippo Mixer, Collomix-LevMix). Richtige Konsistenz über Ausbreitmaß bestimmen.", "Auftrag: Einbaudicke 10-35 mm, ab 10 mm applizierbar, bei stark beanspruchten Böden mind. 13 mm. Materialverbrauch ca. 1,8 kg pro m² und mm Schichtstärke. Auftrag gleichmäßig, Entlüften mit Kunststoff-Stachelwalze.", "Verarbeitungszeit: Verarbeitungszeit ca. 20 Minuten, Fließzeit ca. 15 Minuten. Innerhalb von 20 Minuten verarbeiten.", "Aushärtung: Begehbar nach 2-3 Stunden, Schleifen frühestens nach 24 Stunden Einbau. Druckfestigkeit nach 24 Stunden ca. 34 N/mm², nach 28 Tagen ca. 48 N/mm²."]}],
    verarbeitungMeta: [{"titel": "Besonderheiten", "text": "Umgebungs- und Untergrundtemperatur 10-30 °C, Materialtemperatur 16-27 °C, Materialtemperatur über +10 °C halten. Temperaturen über 20 °C beschleunigen Abbinden und Festigkeit (möglichst kaltes Anmachwasser), unter 20 °C verlangsamen sie (Material/Wasser aufwärmen). Fläche bis zur Begehbarkeit vor zu schneller Austrocknung, Wind, Zugluft und Sonneneinstrahlung schützen. Bei extrem trockenen/windigen/heißen Bedingungen Nachbehandlung mit feinem Wassernebel. Flächen bis zur Hochglanzoptik schleifbar (bis zu 3 mm Abtrag), abschließend Imprägnierung/Einpflege empfohlen."}],
    kategorie: "estrich",
    bereich: "industrieboden",
    produktgruppe: "truazzo",
    ...
    normen: ["DIN EN 13813"],
    technischeDaten: [
      { label: "Druckfestigkeit (ASTM C-109 mod.)", wert: "nach 4 h ca. 19 N/mm², nach 1 Tag ca. 34 N/mm², nach 28 Tagen ca. 48 N/mm²", norm: "DIN EN 13892-2" },
  ...
  },
  {
    ...
    name: "TRU SP",
    verarbeitungModi: [{"titel": "Schicht auf erhärteten Beton (10-35 mm)", "schritte": ["Untergrund: Zementären Untergrund als Tragbeton C25/30 oder Tragestrich mindestens CT-C35-F5 vorbereiten (z. B. Fräsen, Kugelstrahlen). Untergrund tragfähig, fest, sauber, trocken, frei von losen Teilen, Ölen und Fetten. Oberflächenzugfestigkeit >= 1,5 N/mm2 (befahren) bzw. >= 1,0 N/mm2 (nicht befahren), Anforderungen DIN 18365 und DIN 18560-3. Risse, Ausbrüche und schadhafte Fugen instand setzen, Fugen übernehmen. Tragestriche zementär, schwundarm, maschinengeglättet, Schichtstärke mind. 65 mm. Anschließend 2-komponentige Epoxidharz-Grundierung KORODUR TXPK aufbringen und mit feuergetrocknetem Quarzsand Körnung 0,4-0,8 mm satt absanden.", "Mischen: Wasserzugabe ca. 3,8-4,3 l je 27,2 kg Gebinde. Zunächst 4 l Wasser vorlegen, dann TRU SP zugeben; maximale Wassermenge 4,3 l nicht überschreiten. Mischtechnik mit mind. 650 UpM (z. B. Hippo Mixer, Collomix-LevMix), keine lufteintragende Technik. Mischzeit 3-5 Minuten bis klumpenfreie Konsistenz. Richtige Konsistenz über Ausbreitmaß (FLOW Kit) prüfen.", "Auftrag: Einbaudicke 10-35 mm, Applikation ab 10 mm; bei stark beanspruchten Böden 13 mm. Auftrag auf vorbereitetem, grundiertem Untergrund, gleichmäßig mit Rakel. Lufteinschlüsse mit Kunststoff-Stachelwalze entfernen. Materialverbrauch ca. 1,8 kg/m2 je mm Schichtstärke.", "Verarbeitungszeit: Bis zu 20 Minuten verarbeitbar (innerhalb von 20 Minuten verarbeiten), Fließzeit ca. 15 Minuten. Materialtemperatur über 10 °C halten.", "Aushärtung: Begehbar nach 2-3 Stunden, schleifbar nach 24 Stunden. Druckfestigkeit nach 24 Stunden ca. 27 N/mm2, nach 28 Tagen ca. 44 N/mm2."]}],
    verarbeitungMeta: [{"titel": "Besonderheiten", "text": "Verarbeitungs-, Umgebungs- und Untergrundtemperatur >= 5 °C; Umgebungs-/Untergrundtemperatur 10-30 °C, Materialtemperatur 16-27 °C. Temperaturen über 20 °C beschleunigen, unter 20 °C verlangsamen das Abbinden (Anmachwasser kühlen bzw. erwärmen). Frisch aufgetragene Fläche bis zur Begehbarkeit vor Austrocknung, Zugluft und Sonneneinstrahlung schützen. Fugen im erhärteten Tragbeton in der Sichtestrichschicht übernehmen, von aufgehenden Bauteilen trennen. Nachbehandlung mit Wasser bei 20 °C normalerweise nicht erforderlich, bei trockenen/windigen/heißen Bedingungen feiner Wassernebel. Beim Schleifen werden bis zu 3 mm der Einbaustärke abgetragen; nach Trocknung Imprägnierung/Einpflege empfohlen."}],
    kategorie: "estrich",
    bereich: "industrieboden",
    produktgruppe: "truazzo",
    ...
    normen: ["DIN EN 13813"],
    technischeDaten: [
      { label: "Druckfestigkeit (ASTM C-109 mod.)", wert: "nach 4 h ca. 13 N/mm², nach 1 Tag ca. 27 N/mm², nach 28 Tagen ca. 44 N/mm²", norm: "DIN EN 13892-2" },
      { label: "Verarbeitungszeit", wert: "ca. 20 Minuten" },
      { label: "Fließzeit", wert: "ca. 15 Minuten" },
      { label: "Materialverbrauch", wert: "ca. 1,8 kg pro m² und mm Schichtstärke" },
      { label: "Farbe", wert: "naturgrau" },
  ...
  },
  {
    ...
    name: "MICROTOP TW 3",
    verarbeitungModi: [{"titel": "Schicht auf erhärteten Beton (9-20 mm)", "schritte": ["Untergrund: Tragbeton/Altputz (Haftzugfestigkeit mind. 1,5 N/mm2) grundsaetzlich strahlen, vorzugsweise mit HD-Wasser ab 1.000 bar. Oberflaeche rissefrei, eben, frei von losen und muerben Bestandteilen sowie Feinstmoertelanreicherungen, rau und offenporig. Untergrund einen Tag vor der Verarbeitung gruendlich vornaessen; Applikation auf die mattfeuchte Oberflaeche.", "Mischen: Wasserzugabe ca. 2,5 l je 25-kg-Gebinde. W/Z-Wert max. 0,5 einhalten, Ueberpruefung mittels Darrversuch.", "Auftrag: Einlagige Verarbeitung im Trockenspritzverfahren (Duennstromfoerderung gem. DIN 18551), vorbenetzt oder trocken. Reprofilieren und Beschichten, gerieben und geglaettet. Schichtstaerke ca. 9-20 mm (Koernung 0-3 mm).", "Aushärtung: Nachbehandlung: relative Luftfeuchte nach der Applikation mind. 10 Tage auf 95 % halten, Waermeeintrag dabei max. 20 C. Zugluft und groessere Luftbewegungen vermeiden."]}],
    verarbeitungMeta: [{"titel": "Besonderheiten", "text": "Fuer den Trinkwasserbereich, DVGW-konform (Typ Klasse 1, W 300, W 347). Verarbeitungs-, Umgebungs- und Untergrundtemperatur mind. 5 C. Wasserkammern klimatisieren, um Kondenswasserbildung zu verhindern."}],
    kategorie: "sonstige",
    bereich: "microtop",
  ...
  },
  {
    ...
    tdsUrl: "/downloads/tds/MICROTOP_TW_3_5_8_de.pdf",
    name: "MICROTOP TW 5",
    verarbeitungModi: [{"titel": "Schicht auf erhärteten Beton (14-30 mm)", "schritte": ["Untergrund: Tragbeton/Altputz (Haftzugfestigkeit mind. ≥ 1,5 N/mm²) grundsätzlich strahlen, vorzugsweise mit HD-Wasser ≥ 1.000 bar. Oberfläche kraftschlüssig, rissefrei, eben, frei von losen/mürben Bestandteilen und Feinstmörtelanreicherungen, rau und offenporig. Untergrund einen Tag vor der Verarbeitung gründlich vornässen; Applikation auf mattfeuchte Oberfläche.", "Mischen: Wasserzugabe ca. 2,3 l je 25-kg-Gebinde. W/Z-Wert ≤ 0,5 einhalten, Überprüfung mittels Darrversuch. Verarbeitungstemperatur ≥ 5 °C.", "Auftrag: Körnung 0 - 5 mm, Qualität C 30/37. Schichtstärke ca. 14 - 30 mm. Einlagige Verarbeitung im Trockenspritzverfahren (Dünnstromförderung gem. DIN 18551, vorbenetzt oder trocken); reib-, glätt- und von Hand nacharbeitbar.", "Aushärtung: Nachbehandlung: relative Luftfeuchte nach der Applikation mittels Luftbefeuchtern mind. 10 Tage auf 95 % halten, bis ausreichende mechanische Festigkeit erreicht ist. Wärmeeintrag max. 20 °C, Zugluft und größere Luftbewegungen vermeiden."]}],
    verarbeitungMeta: [{"titel": "Besonderheiten", "text": "Microsilica-vergüteter Spritzmörtel für den Trinkwasserbereich, entspricht DVGW Arbeitsblatt Typ Klasse 1, W 300 und W 347. Klimatisierung der Wasserkammern zur Verhinderung von Kondenswasserbildung erforderlich."}],
    qualitaetsklasse: "C30/37",
    kategorie: "sonstige",
    bereich: "microtop",
    produktgruppe: "trockenspritz",
    ...
    technischeDaten: [
      { label: "Korngröße", wert: "0–5 mm" },
      { label: "Druckfestigkeit", wert: "≥ 45 N/mm²", norm: "DIN EN 206" },
  ...
  },
  {
    ...
    tdsUrl: "/downloads/tds/MICROTOP_TW_3_5_8_de.pdf",
    name: "MICROTOP TW 8",
    verarbeitungModi: [{"titel": "Schicht auf erhärteten Beton (ab 25 mm)", "schritte": ["Untergrund: Tragbeton/Altputz (Haftzugfestigkeit mind. ≥ 1,5 N/mm²) grundsätzlich strahlen, vorzugsweise mit HD-Wasser ≥ 1.000 bar. Oberfläche rissefrei, eben, frei von losen und mürben Bestandteilen sowie Feinstmörtelanreicherungen, rau und offenporig. Untergrund einen Tag vor der Verarbeitung gründlich vornässen.", "Mischen: Wasserzugabe ca. 2,2 l je 25-kg-Gebinde. W/Z-Wert ≤ 0,5 einhalten (Überprüfung mittels Darrversuch).", "Auftrag: Körnung 0-8 mm, Schichtstärke ≥ 25 mm. Einlagige Applikation auf mattfeuchte Oberfläche im Trockenspritz-/Dünnstromverfahren gem. DIN 18551 (vorbenetzt oder trocken). Materialgüte C 30/37."]}],
    verarbeitungMeta: [{"titel": "Besonderheiten", "text": "Verarbeitungs-, Umgebungs- und Untergrundtemperatur ≥ 5 °C. Nachbehandlung: relative Luftfeuchte nach der Applikation mind. 10 Tage auf 95 % halten (Luftbefeuchter), Wärmeeintrag max. 20 °C, Zugluft und größere Luftbewegungen vermeiden; Wasserkammern zur Vermeidung von Kondenswasser klimatisieren. Material lässt sich reiben, glätten und für kleine Arbeiten von Hand ausführen. DVGW-konform (Typ Klasse 1, W 300, W 347) für den Trinkwasserbereich."}],
    kategorie: "sonstige",
    bereich: "microtop",
    produktgruppe: "trockenspritz",
  ...
  },
  {
    ...
    name: "MICROTOP TW BM",
    verarbeitungModi: [{"titel": "Schicht auf erhärteten Beton (5 - 8 mm)", "schritte": ["Untergrund: Tragfähigen Untergrund vorbereiten: rissfrei, eben, frei von losen und mürben Bestandteilen und Feinstmörtelanreicherungen, rau und offenporig für einen kraftschlüssigen Verbund. Anschließend vornässen.", "Mischen: Wasserzugabe ca. 5 bis 6,25 l je 25 kg, W/Z-Wert kleiner/gleich 0,5. Als komplettes Gebinde mit der vorgeschriebenen Wassermenge ca. 3 Minuten mit langsam laufendem Zwangsmischer/Quirl anmischen.", "Auftrag: Schichtstärke ca. 5 bis 8 mm. Verarbeitbar im Schleuder-, Spritz- und Handauftrag (Dichtstromverfahren oder von Hand). Auch als Haftbrücke für Bodenbeschichtungen und als Korrosionsschutz einsetzbar.", "Aushärtung: Druck- und Biegezugfestigkeit gemessen nach 28 Tagen (Druck größer/gleich 35 N/mm², Biegezug größer/gleich 6 N/mm²). Unterschiedliche Temperaturen beeinflussen Erstarrungs- bzw. Erhärtungsverlauf."]}],
    verarbeitungMeta: [{"titel": "Besonderheiten", "text": "Verarbeitungs-, Umgebungs- und Untergrundtemperatur mindestens 5 °C. Nachbehandlung: vor zu rascher Austrocknung gemäß DIN EN 13670 / DIN 1045-3 schützen. Trinkwasserzulassung nach DVGW Typ Klasse 1, W 300 und W 347."}],
    kategorie: "beschichtung",
    bereich: "microtop",
    ...
    technischeDaten: [
      ...
      { label: "Druckfestigkeit", wert: "35 N/mm²", norm: "DIN EN 13892-2" },
      { label: "Biegezugfestigkeit", wert: "6,3 N/mm²", norm: "DIN EN 13892-2" },
  ...
  },
  {
    ...
    verarbeitung: {"untergrundvorbereitung": "Untergrund muss für kraftschlüssigen Verbund rissefrei, eben und frei von losen und mürben Bestandteilen sowie Feinstmörtelanreicherungen sein. Vor der Applikation mattfeucht vornässen.", "mischverhaeltnis": "Produkt ist gebrauchsfertig. Bei schwachsaugendem Untergrund mit Wasser 1:1 verdünnen.", "schichtaufbau": "Applikation mit Pinsel oder Niederdruck-Spritzgerät (Gartenspritze), nicht zu fein vernebeln (sonst keine geeignete Reaktion). Je nach Saugfähigkeit des Untergrunds in einem oder mehreren Schritten. Materialverbrauch ca. 150 bis 250 g/m² je nach Porosität, exakte Werte über Vorversuche ermitteln.", "verarbeitungszeit": "Applikation frühestens nach 7 Tagen (nach Herstellung des Untergrunds).", "besonderheiten": "Reagiert alkalisch. Nicht in Aluminium- oder verzinkten Gebinden lagern. Nicht im frischen Zustand mit Glas oder Aluminium in Verbindung bringen, falls doch mit reichlich Wasser abspülen. Gem. DVGW für die Trinkwasseranlagenaufbereitung geeignet."},
    kategorie: "beschichtung",
    bereich: "microtop",
    produktgruppe: "beschichtung-schutz",
  ...
  // zuordnung-spezialbaustoffe-rapidset.md).
  {
    ...
    name: "KOROPHALT 02",
    verarbeitung: {"untergrundvorbereitung": "4 bis 6 cm starke halbstarre Deckschicht auf ein- bis zweilagiger Asphalttragschicht. Basis ist ein speziell entwickeltes Einkorn-Asphalt-Traggeruest mit 25 bis 30 % Hohlraumgehalt.", "mischverhaeltnis": "Wasserzugabe ca. 5,75 bis 6,0 l je 25 kg. Anmischen mit geeignetem Zwangsmischer oder Ruehrquirl (ca. 400 UpM), bei groesseren Flaechen mit Moertelpumpen oder als Siloware (KORODUR Silotechnik).", "schichtaufbau": "Zweistufig: Im ersten Arbeitsgang das Asphalt-Traggeruest einbauen, im zweiten die Hohlraeume mit KOROPHALT 02 verfuellen. Dank niedriger Viskositaet fliesst der Moertel ohne maschinelle Unterstuetzung ins Traggeruest ein. Saubere, moertelueberschussfreie Oberflaeche durch scharfes Abziehen mit einem Gummischieber.", "aushaertezeit": "Belastbar mit Verkehr nach ca. 12 bis 24 Stunden (20 Grad C). Druckfestigkeit nach 24 h ca. 40 N/mm2, nach 28 Tagen ca. 70 N/mm2.", "besonderheiten": "Verarbeitungstemperatur mindestens 5 Grad C. Temperaturen beeinflussen Erstarrungs- und Erhaertungsverlauf. Vor zu rascher Austrocknung schuetzen (gem. DIN EN 13670 / DIN 1045-3). Auch farbig lieferbar."},
    kategorie: "sonstige",
    ...
    normen: ["FGSV M HD"],
    technischeDaten: [
      { label: "Druckfestigkeit (28 d)", wert: "ca. 70 N/mm²", norm: "DIN EN 1015-11" },
      { label: "Druckfestigkeit (24 h)", wert: "ca. 40 N/mm²", norm: "DIN EN 1015-11" },
      { label: "Biegezugfestigkeit (28 d)", wert: "ca. 8 N/mm²", norm: "DIN EN 1015-11" },
      { label: "E-Modul (28 d)", wert: "ca. 10.000–12.000 N/mm²", norm: "DIN EN 12697-26" },
  ...
  },
  {
    ...
    name: "NEODUR VM 5",
    verarbeitungModi: [{"titel": "Schicht auf erhärteten Beton (bis 200 mm)", "schritte": ["Untergrund: Untergrund fuer kraftschluessigen Verbund rissefrei, eben, frei von losen Teilen, Staub, Zementschlaemme, Oelen und Fetten. Gruendlich vornaessen, Pfuetzenbildung vermeiden.", "Mischen: Wasserzugabe ca. 3,0 bis 3,2 l je 25 kg (Ergiebigkeit ca. 12 bis 13 l je 25 kg). Als komplettes Gebinde ca. 3 Minuten mit Ruehrquirl (ca. 400 UpM) anmischen oder mit geeigneter Misch- und Pumptechnik verarbeiten.", "Auftrag: Untergusshoehe/-breite bis 200 mm. Verguss hohlraumfrei und ohne Arbeitsunterbrechung ausfuehren, dabei auf Entlueftung achten.", "Aushärtung: Schnellabbindend mit hoher Frueh- und Endfestigkeit. Unterschiedliche Temperaturen beeinflussen den Erstarrungs- bzw. Erhaertungsverlauf. Vor zu rascher Austrocknung gem. DIN EN 13670 / DIN 1045-3 schuetzen."]}],
    verarbeitungMeta: [{"titel": "Besonderheiten", "text": "Verarbeitungstemperatur >= 5 grad C. Pumpbar mit geeigneter Technik (z. B. Putzmeister S 5 EV EVTM, PA-BEC von Bau-Maschinen Beckschulte, Project CP 30 BASIC von EUROMAIR, EMT 75 von ESKA)."}],
    kategorie: "sonstige",
  ...
  },
  {
    ...
    verarbeitungModi: [{"titel": "Schicht auf erhärteten Beton (15-200 mm)", "schritte": ["Untergrund: Untergrund muss für kraftschlüssigen Verbund rissefrei, eben und frei von losen Teilen, Staub, Zementschlämmen, Ölen und Fetten sein. Gründlich vornässen, Pfützenbildung vermeiden. Temperatur ab 5 °C.", "Mischen: Wasserzugabe ca. 3,0 bis 3,2 l je 25-kg-Gebinde (Ergiebigkeit ca. 12 bis 13 l/25 kg). Komplettes Gebinde ca. 3 Minuten mit Rührquirl (ca. 400 UpM) anmischen oder mit geeigneter Misch- und Pumptechnik verarbeiten.", "Auftrag: Untergusshöhe/-breite 15 bis 200 mm. Verguss hohlraumfrei und ohne Arbeitsunterbrechung ausführen, dabei auf Entlüftung achten.", "Verarbeitungszeit: Schnellabbindend, daher Verguss ohne Arbeitsunterbrechung. Unterschiedliche Temperaturen beeinflussen Erstarrungs- bzw. Erhärtungsverlauf.", "Aushärtung: Druckfestigkeit nach 1 Tag >= 40 N/mm2, nach 7 Tagen >= 60 N/mm2, nach 28 Tagen >= 75 N/mm2 (C55/67)."]}],
    verarbeitungMeta: [{"titel": "Besonderheiten", "text": "Schrumpffrei (Quellmaß >= 0,1 Vol.-%), chloridfrei, frost- und tausalzbeständig, wasserundurchlässig. Trinkwassergeeignet gem. DVGW-Arbeitsblatt W 347. Für innen und außen. Pumpbar u. a. mit Putzmeister S 5 EV EVTM, Bau-Maschinen Beckschulte PA-BEC, EUROMAIR Project CP 30 BASIC oder ESKA EMT 75. Vor zu rascher Austrocknung gem. DIN EN 13670 / DIN 1045-3 schützen."}],
    kategorie: "sonstige",
  ...
  },
  {
    ...
    name: "NEODUR SVM 03",
    verarbeitungModi: [{"titel": "Schicht auf erhärteten Beton (5-30 mm)", "schritte": ["Untergrund: Untergrund fuer kraftschluessigen Verbund rissefrei, eben, frei von losen Teilen, Staub, Zementschlaemme, Oel und Fett. Gruendlich vornaessen, Pfuetzenbildung vermeiden.", "Mischen: Wasserzugabe ca. 5,3 l je 25 kg (SVM 03). Als komplettes Gebinde mit der vorgeschriebenen Wassermenge ca. 1-2 Minuten mit geeignetem Zwangsmischer oder Ruehrquirl (ca. 400 UpM) anmischen.", "Auftrag: Untergusshoehe/-breite ca. 5-30 mm (SVM 03). Verguss hohlraumfrei und ohne Arbeitsunterbrechung ausfuehren, dabei auf Entlueftung achten.", "Aushärtung: Druckfestigkeit SVM 03: nach 1 Stunde >= 8 N/mm2, nach 24 Stunden >= 23 N/mm2, nach 28 Tagen >= 55 N/mm2. Kurzfristig belastbar (schnelle Anfangsfestigkeiten)."]}],
    verarbeitungMeta: [{"titel": "Besonderheiten", "text": "Verarbeitungs-, Umgebungs- und Untergrundtemperatur >= 5 C. Vor zu rascher Austrocknung gem. DIN EN 13670 / DIN 1045-3 schuetzen. Chloridfrei und wasserundurchlaessig. Guete C50/60, Koernung 0-0,5 mm."}],
    kategorie: "sonstige",
  ...
  },
  {
    id: "neodur-svm-4",
    name: "NEODUR SVM 4",
    verarbeitung: {"untergrundvorbereitung": "Untergrund muss fuer kraftschluessigen Verbund rissfrei, eben und frei von losen Teilen, Staub, Zementschlaemme, OEl und Fett sein. Gruendlich vornaessen, Pfuetzenbildung vermeiden.", "mischverhaeltnis": "Wasserzugabe ca. 3,0 l je 25 kg. Komplettes Gebinde ca. 1-2 Minuten mit Zwangsmischer oder Ruehrquirl (ca. 400 UpM) anmischen. Ergiebigkeit ca. 12-13 l/25 kg.", "schichtaufbau": "Untergusshoehe/-breite ca. 10-50 mm. Verguss hohlraumfrei und ohne Arbeitsunterbrechung, dabei auf Entlueftung achten.", "aushaertezeit": "Druckfestigkeit: nach 1 Stunde >= 7 N/mm2, nach 24 Stunden >= 15 N/mm2, nach 28 Tagen >= 40 N/mm2 (C35/45). Schnelle Anfangsfestigkeit, kurzfristig belastbar. Temperaturen beeinflussen Erstarrungs- und Erhaertungsverlauf.", "besonderheiten": "Verarbeitungs-, Umgebungs- und Untergrundtemperatur >= 5 C. Vor zu rascher Austrocknung gem. DIN EN 13670 / DIN 1045-3 schuetzen. Chloridfrei und wasserundurchlaessig. Fuer innen und aussen. Besonders geeignet fuer den Verguss von Fahrleitungsmasten zur Elektrifizierung von Bahnstrecken."},
    kategorie: "sonstige",
    // #308: Schnellvergussmörtel → Sammelbereich Betonsanierung.
    bereich: "spezialmoertel",
    aussenbereich: true,
  ...
  },
  {
    ...
    name: "NEODUR MSM 3",
    verarbeitung: {"untergrundvorbereitung": "Tragbeton mit Oberflächenzugfestigkeit >= 1,5 N/mm2 vorbereiten. Oberfläche säubern, lose Teile wie Staub und Zementschlämme bis zum tragfähigen Untergrund entfernen und ggf. aufrauen. Lose Bewehrung entfernen, eventuell neue Bewehrung schwingungsfrei einbringen. Untergrund gründlich bis zur Kapillarsättigung vornässen.", "schichtaufbau": "Einlagig, Schichtstärke ca. 15-50 mm. Applikation auf die mattfeuchte Oberfläche gem. DIN 18551 im Trockenspritzverfahren (Körnung 0-3 mm). Wasserzugabe erfolgt an der Düse.", "besonderheiten": "Maschinell spritzbar, auch über Kopf; verarbeitbar, verreibbar und glättbar. Homogenes Spritzbild und geringer Rückprall durch gleichmäßige Kreisbewegungen der Spritzdüse bei ca. 1 m Abstand und 90-Grad-Winkel zur Wand. Verarbeitungs-, Umgebungs- und Untergrundtemperatur >= 5 °C. Ergiebigkeit ca. 12 l/25 kg. Nachbehandlung: vor zu rascher Austrocknung gem. DIN EN 13670 / DIN 1045-3 schützen; unterschiedliche Temperaturen beeinflussen Erstarrungs- und Erhärtungsverlauf."},
    kategorie: "sonstige",
  ...
  },
  {
    ...
    tdsUrl: "/downloads/tds/NEODUR_MSM_3_5_MSB_8_de.pdf",
    name: "NEODUR MSM 5",
    verarbeitung: {"untergrundvorbereitung": "Tragbeton (Oberflächenzugfestigkeit ≥ 1,5 N/mm²) vorbereiten. Oberfläche säubern, lose Teile wie Staub und Zementschlämme bis zum tragfähigen Untergrund entfernen und ggf. aufrauen. Lose Bewehrung entfernen, eventuell neue Bewehrung schwingungsfrei einbringen. Untergrund gründlich bis zur Kapillarsättigung vornässen. Applikation auf mattfeuchte Oberfläche.", "schichtaufbau": "Körnung 0 bis 5 mm, zementgrau, Qualität C35/45. Schichtstärke ca. 15 bis 50 mm, einlagig. Ergiebigkeit ca. 12 l/25 kg.", "aushaertezeit": "Unterschiedliche Temperaturen beeinflussen Erstarrungs- und Erhärtungsverlauf. Vor zu rascher Austrocknung gem. DIN EN 13670 / DIN 1045-3 schützen.", "besonderheiten": "Trockenspritzverfahren gem. DIN 18551, maschinell spritzbar, auch über Kopf. Gleichmäßige Kreisbewegungen der Spritzdüse bei ca. 1 m Abstand und 90°-Winkel zur Wand ergeben ein homogenes Spritzbild, geringen Rückprall und optimale Betonqualität. Verarbeitungs-, Umgebungs- und Untergrundtemperatur ≥ 5 °C. Materialien können über Kopf verarbeitet, gerieben und geglättet werden."},
    kategorie: "sonstige",
    // #308: Microsilica-Spritzmörtel → Sammelbereich Betonsanierung.
    bereich: "betonsanierung",
    zusatzBereiche: ["spezialmoertel"],
  ...
  },
  {
    ...
    tdsUrl: "/downloads/tds/NEODUR_MSM_3_5_MSB_8_de.pdf",
    name: "NEODUR MSB 8",
    verarbeitung: {"untergrundvorbereitung": "Tragbeton mit Oberflaechenzugfestigkeit >= 1,5 N/mm2 vorbereiten. Oberflaeche saeubern, lose Teile wie Staub und Zementschlaemme bis zum tragfaehigen Untergrund entfernen und ggf. aufrauen. Lose Bewehrung entfernen, ggf. neue Bewehrung schwingungsfrei einbringen. Untergrund gruendlich bis zur Kapillarsaettigung vornaessen.", "schichtaufbau": "Einlagig, Schichtstaerke ca. 15-50 mm. Applikation auf mattfeuchte Oberflaeche gem. DIN 18551 im Trockenspritzverfahren (Koernung 0-8 mm). Ergiebigkeit ca. 12 l/25 kg.", "besonderheiten": "Maschinell spritzbar, auch ueber Kopf; danach verreib- und glaettbar. Verarbeitungs-, Umgebungs- und Untergrundtemperatur >= 5 degC. Homogenes Spritzbild und geringer Rueckprall durch gleichmaessige Kreisbewegungen der Spritzduese, Abstand ca. 1 m, Winkel 90 Grad zur Wand. Nachbehandlung: vor zu rascher Austrocknung gem. DIN EN 13670 / DIN 1045-3 schuetzen; Temperatur beeinflusst Erstarrungs- und Erhaertungsverlauf."},
    kategorie: "sonstige",
  ...
  },
  {
    ...
    verarbeitung: {"mischverhaeltnis": "Alle drei Additive: maximal 4 Beutel je 25 kg Sack Rapid Set Reparaturmörtel. 1 Beutel SET Control auf 25 kg CEMENT ALL, MORTAR MIX oder CONCRETE MIX verlängert die Abbindezeit um bis zu 20 Min.", "verarbeitungszeit": "SET Control verlängert die Verarbeitungs- bzw. Abbindezeit, um bei großen, komplexen Verlegungen oder höheren Temperaturen mehr Zeit zu gewinnen. Die Verzögerung kann temperaturbedingt variieren.", "aushaertezeit": "FAST beschleunigt die Abbindezeit (ideal bei kalten Temperaturen und wenn kürzeste Abbindezeiten gefordert sind), SET Control verzögert sie. Beschleunigung und Verzögerung können durch schwankende physikalische Parameter (z. B. temperaturbedingt) variieren.", "besonderheiten": "SET Control und FAST werden im Mischwasser aufgelöst, FLOW Control wird während des ersten Mischvorgangs direkt zugegeben. FLOW Control verbessert die Fließfähigkeit erheblich und spart bei gleicher Konsistenz (Ausbreitmaß) 20 bis 40 % Anmachwasser. Die Additive lassen sich untereinander kombinieren. Wir empfehlen eine Probemischung, um die gewünschten Eigenschaften auf die örtlichen Bedingungen abzustimmen."},
    kategorie: "sonstige",
    bereich: "betonsanierung",
