...
const punktuell: LoesungsfinderState = { flaeche: "punktuell", innenAussen: "innen", einsatzbereich: "innen-industrie-halle", zeitfenster: null };
...
check("Mittel ohne zeitfenster kein Ergebnis", berechneErgebnisV25({ flaeche: "mittel", innenAussen: "innen", einsatzbereich: "innen-industrie-halle", zeitfenster: null }).topProdukt === null);

// 3. Außen-Filter: Top-Produkt muss außentauglich sein.
const aussen = berechneErgebnisV25({ flaeche: "gross", innenAussen: "aussen", einsatzbereich: "aussen-parkdeck", zeitfenster: "planbar" });
...
const sehrKurz = berechneErgebnisV25({ flaeche: "gross", innenAussen: "innen", einsatzbereich: "innen-industrie-halle", zeitfenster: "sehr-kurz" });
...
const innenCases: LoesungsfinderState[] = [
  { flaeche: "punktuell", innenAussen: "innen", einsatzbereich: "innen-industrie-halle", zeitfenster: null },
  { flaeche: "mittel", innenAussen: "innen", einsatzbereich: "innen-industrie-halle", zeitfenster: "kurz" },
  { flaeche: "gross", innenAussen: "innen", einsatzbereich: "innen-industrie-halle", zeitfenster: "sehr-kurz" },
];
