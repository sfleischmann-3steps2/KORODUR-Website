...
- **V3.6 — Portfolio-Umbau + Bereichsseiten-Redesign (deployed 2026-06-17, PRs #234/#237/#238/#243/#244):** Technik-Feedback (Menü/Bereiche/Produktzuordnung) komplett umgesetzt (Epic #214 + Bereichsseiten-Redesign + #170). SoT: `docs/reviews/2026-06-17-technik-feedback-bereiche.md`. **Kern-Datenschicht (K1–K6):** Multi-Bereich-Modell (`zusatzBereiche[]`, Produkt in mehreren Bereichen — KOROCRETE in Betonsanierung **und** Infrastruktur); neuer Bereich **Infrastruktur** ersetzt Schnellbetonsysteme; **5 eingestellte Produkte raus** (KOROPOX, KOROTAN-Additiv, NEODUR AM Super/Plus, MICROTOP TW NSD → **78→71 Produkte**, System KORODUR-KOROTAN bleibt); DIN-1100-Hartstoffe auf Estriche/Einstreuung verteilt + „additive"-Gruppe entfällt; Per-Bereich-Heading „{Bereich} Produkte". **Presentation (P1–P8):** Menü „Bereiche"→**„Portfolio"**, rapid-set→**Betonsanierung**, Microtop-Menü-Kurzname „TW-Behältersanierung", Gruppen-Labels (Haftbrücken & Grundierungen / Dünnbeschichtung & Oberflächenschutz), Sanierung-Dropdown vollständig, **Header +15 %** (Lösungsfinder-Button raus), Footer-Umbau (feste Reihenfolge, Unternehmen-Spalte rechtsbündig), Home-Layout (Hero kompakt + CTAs rechts, Beratungs-CTA mittig), **echte Referenzfotos in den Bereichs-Kacheln**. **Bereichsseiten-Redesign:** einheitlicher Header-CTA „Technische Fachberatung", korrektes Fachberater-Mapping (Sichtestrich→Industrieboden, Spezialbaustoffe→Rapid-Set, Katzenstreu-Festnetzblock), **verschachtelte Sub-Seiten `/bereiche/<slug>/{neubau,sanierung}`** (Industrieboden + Spezialbaustoffe; Referenzen projektart-gefiltert). **#170:** Referenz-Teaser in Fachartikeln (Frontmatter `referenzen:`, 4 Schadensbilder). **1317 Seiten, Build grün, tsc 0, validate 0.** Board-Hygiene: alle erledigten Issues completed + Done. Offen (→ Notion-Frageseite, Technik): **T1** KOROPOX-Öl/Treibstoff-Ersatz, **T2** DIN-1100-Estrich/Einstreuung-Bestätigung, **T3** produktseitige Projektart-Klassifizierung (#83/#103); **B1** 3D-Druck befüllen; Faktencheck-🔴 (15.06.); i18n der Ratgeber/Schadensbilder (#181). Gotcha gelernt: Squash + Komma-`Closes` schließt nur 1 Issue, Org-Board zieht nicht auto auf Done.
- **V3.5 — Website-Relaunch-Walkthrough umgesetzt (2026-06-14, #107–#120):** Walkthrough-Feedback (`docs/reviews/2026-06-13-website-walkthrough-feedback.md`) als Issues #72–#106 systematisiert und abgearbeitet: bereichs-zentrierte IA (Bereiche in die Top-Nav, Hover-Mega-Menüs + Mobile-Accordion, Produkt-Gesamtkatalog in den Footer, #72/#81/#82), Bereichsseiten Neubau + Sanierung mit Referenz-Sektionen + wiederkehrenden Kontakt-CTAs + Neubau/Sanierung-Framing nur bei Doppelnutzung (#73/#86/#119), Fachberater-Finder nach Bereich + PLZ mit Deep-Link `?bereich=` (#90/#91), zentrale Ikonografie + Cross-Selling-Blöcke (#104/#84), Home-Finder-CTA 4 Schritte (#89), Referenz-Karten mit Bereich-Chip + Neubau-Referenz-Import auf Home/Neubau (#98/#99/#88/#85), Lösungsfinder-Scroll-/Höhensprung-Fixes (#101/#102), 59 TDS verlinkt + Norm-Korrekturen gegen Excel-SoT + Dokument-Inventar je Produkt (#92/#96/#120). **78 Produkte, 5 Sprachen DE/EN/FR/PL/ES.** Heute zusätzlich: Spec Produkt-Klassifizierung gegen Excel-SoT für #93/#94/#97/#110 (`docs/specs/2026-06-14-produkt-klassifizierung-sot.md`, 8 Frank-Sign-off-Fragen offen) + Spezialbaustoffe-Umgruppierung MSM/MSB → Produktgruppe `spritzmoertel` (#94). Branch-Hygiene: obsolete UI-/Relaunch-/`launch-*`-Branches und `korb2` (vollständig in `main` aufgegangen) aufgeräumt. Offen (Issues): Normen-Glossar (#97), Lösungsfinder-i18n + Mapping mit Frank (#103), Bild-System Bereich×Projektart (#105), Varianten-PDP (#110), Kontakt-i18n DE/International (#118), C44/55-Diskrepanz + weitere Norm-Fixes bei Frank.
...
app/[lang]/              Locale-prefixed Routes (Static-Export-fähig)
  ...
  dictionaries/          UI-Strings (5 Sprachen)
...
- **i18n Pflicht:** Neue UI-Strings IMMER in allen 5 Sprach-Dictionaries (gegen KORODUR-Glossar prüfen)
