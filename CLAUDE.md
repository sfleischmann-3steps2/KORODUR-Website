...
- **Nächste Iteration:** A2-Flag-Flip nach Frank-Sign-off der kuratierten Tabelle. Team-Feedback aus Hardcore-Test einarbeiten (Filter-Feinjustierung, Tag-Sign-off Frank). Referenz-Detailseite v3 (dynamisches Mockup in `docs/mockups/Referenz-Detail-Mockup-v3.html`) als nächster UI-Kandidat.
