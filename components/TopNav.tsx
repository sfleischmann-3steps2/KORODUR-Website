      ...
      clusters: [
        {
          ...
          items: [
            { label: pa["produktart_hartstoff-din1100"], href: paHref("hartstoff-din1100") },
            { label: pa["produktart_hartstoffeinstreuung"], href: paHref("hartstoffeinstreuung") },
            { label: pa["produktart_hartstoffschicht"], href: paHref("hartstoffschicht") },
        ...
        },
        {
          ...
          items: [
            { label: pa["produktart_reparaturmoertel"], href: paHref("reparaturmoertel") },
            { label: pa["produktart_spritzmoertel"], href: paHref("spritzmoertel") },
