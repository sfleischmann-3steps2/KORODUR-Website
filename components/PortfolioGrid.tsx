...
// /bereiche-Übersicht. Zeigt die 7 kuratierten Bereiche; `infrastruktur` ist
// seit #216 ein echter, klickbarer Bereich. `katzenstreu` bleibt eigener
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      {PORTFOLIO_SLUGS.map((slug) => {
        ...
        const inner = (
          <>
            <span
              className="flex items-center justify-center w-11 h-11 rounded-xl mb-1 bg-navy"
              aria-hidden="true"
            >
              <AppIcon
