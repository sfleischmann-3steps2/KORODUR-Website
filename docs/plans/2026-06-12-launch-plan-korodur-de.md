...
|---|---|---|---|
| **M1: Sofort-Fixes** ✅ (PR #62, gemerged 2026-06-12) | B1 (CTAs intern + CI-Gate), B2 (Redaktionsnotiz), B6 (basePath), A2-Flip (Freigabe bestätigt), Homepage-Title, Nav-Label, manifest.json, Packshots, Featured-Lokalisierung. Offen (Steffi): Archiv-Sicherung, GA4-Cache-Purge, GSC anlegen, microtop-tw-Packshot-Zuordnung | ~1 Tag | Kein Lead-Leck mehr zur Alt-Site, A2 live |
| **M2: Technisches Fundament** ✅ (PR 2026-06-12) | B3 (Impressum/Datenschutz live, Quelle Wayback 2026-01-31; AGB/Hinweisgeber = Entscheidung #6 offen), SEO-Paket komplett (sitemap/robots/canonical/hreflang/OG/404/Referenzübersicht crawlbar/Matrix-Metadata lokalisiert), Performance-Paket (Referenzbilder ≤1600px mozjpeg, 640px-Thumbs für Cards+Galerie, Skript scripts/optimize-referenz-bilder.mjs), Analytics-Scaffold Cloudflare Web Analytics (aktiv, sobald Repo-Variable CF_BEACON_TOKEN gesetzt — Steffi), SITE_URL-Env für Canonical-Wechsel beim Cutover. Offen aus Nice-Liste: Mobile-Hero-Variante, CLS-Fix Matrix, Kontrast | ~1,5–2 Tage | Site ist als offizielle Domain technisch vertretbar |
...
6. **AGB + Hinweisgebersystem (ENTSCHIEDEN Steffi, 2026-06-12): übernehmen** — umgesetzt in M3 (Quelle Wayback; AGB Stand Juli 2016, Hinweisgeber → externes RC-Whistle).
7. Kontrast-Variante (a: dunkleres Cyan für Text, b: akzeptieren und dokumentieren).

## 5b. Neue Anforderungen (Steffi, 2026-06-12)

1. **Spanisch als 5. Sprache, von Beginn an:** ES kommt vor dem Cutover dazu (eigener Meilenstein M3-ES: dictionaries/es.json, Sprachpässe produkte.es.ts + referenzen.es.ts, Unternehmensseiten; hreflang/Sitemap wachsen über LOCALES automatisch mit). Aufwand L.
